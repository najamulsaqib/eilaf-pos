...
Configuration for AI-assisted development on the eilaf-pos project. This folder defines the rules and domain knowledge that all Copilot agents load automatically.
