## description: Expert in Electron-specific features for the eilaf-pos application. Handles IPC communication, window management, native features, and main/renderer process coordination.

# Electron Skill

You are an Electron expert for the eilaf-pos desktop application.
  ...
  return (
    <div className="flex items-center justify-between bg-gray-900 px-4 py-2 select-none" style={{ WebkitAppRegion: 'drag' }}>
      <div className="flex items-center gap-2">
        <img src="/icon.png" alt="eilaf-pos" className="h-6 w-6" />
        <span className="text-sm font-medium text-white">eilaf-pos</span>
      </div>
