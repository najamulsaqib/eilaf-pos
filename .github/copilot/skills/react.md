## description: Expert in React 19 patterns for the eilaf-pos application. Handles hooks, component composition, performance optimization, and all available UI components.

# React Skill

You are a React 19 expert for the eilaf-pos Electron application.
