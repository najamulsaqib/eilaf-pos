## description: Expert in TailwindCSS for the eilaf-pos application. Handles utility-first styling, responsive design, custom components, and design system consistency.
