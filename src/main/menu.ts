...
export default class MenuBuilder {
  ...
  buildDarwinTemplate(): MenuItemConstructorOptions[] {
    const subMenuAbout: DarwinMenuItemConstructorOptions = {
      ...
      submenu: [
        {
          label: 'About Eilaf pos',
          click: () => {
            dialog
              .showMessageBox(this.mainWindow, {
                type: 'info',
                title: 'About Eilaf pos',
                message: 'Eilaf pos Consultancy',
...
📖 GitHub: https://github.com/najamulsaqib/eilaf-pos
🐛 Report Issues: https://github.com/najamulsaqib/eilaf-pos/issues
